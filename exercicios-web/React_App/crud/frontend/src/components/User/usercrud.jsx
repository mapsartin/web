...
export default class UserCrud extends Component {
    ...
    // Atualizar a Lista com uma consulta no backend
    componentWillMount() {
    ...
    save() {
        ...
        // user.id>0 = True então put senão post
    ...
    getUpdateList(user, add = true) {
        ...
        // list.unshift(user)
        // Utilizou a msm função para remove()
        // if (user) list.unshift(user)
        if (add) list.unshift(user)
        return list
    }
    updateField(event) {
        // Clonar objeto e depois definir no setState
        const user = { ...this.state.user }
